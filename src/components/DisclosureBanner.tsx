...
const DisclosureBanner = ({ className = "" }: DisclosureBannerProps) => (
  <div className={`disclosure-banner rounded-xl px-5 py-4 flex gap-3 items-start ${className}`}>
    ...
    <p className="text-sm leading-relaxed">
      <strong>Independent Disclosure:</strong> Trustournet is an independent third-party service assistance provider. We are not affiliated with, authorized by, or endorsed by any telecom or internet service provider.
    </p>
  </div>
);
