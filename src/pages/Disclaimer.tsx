    ...
    <section className="hero-gradient py-16 md:py-24">
      <div className="container max-w-4xl">
        ...
        <p className="text-primary-foreground/80 text-base leading-relaxed max-w-3xl">
          This Disclaimer outlines important information about Trustournet's independent status, limitations, and user responsibilities. 
      ...
      <div className="container max-w-4xl">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-3">
                Trustournet is an <strong>independent third-party service assistance provider</strong>. We are <strong>NOT</strong> an Internet Service Provider (ISP) 
        ...
        <div className="mt-12 rounded-2xl border bg-card p-6">
          ...
          <div className="flex flex-col gap-2 text-sm">
            ...
            <a href="mailto:support@trustournet.com" className="text-primary hover:underline">Email: support@trustournet.com</a>
          </div>
        </div>
      </div>
    </section>
