...
const milestones = [
  { year: "2026", text: "NorthBridge Service Assist launched as an independent assistance platform in Canada." },
  ...
  <PageWrapper>
    ...
    <section className="relative overflow-hidden">
      <div className="absolute inset-0">
        <img src={aboutTeam} alt="NorthBridge Service Assist team" className="w-full h-full object-cover" />
      ...
      <div className="container relative z-10 py-24 md:py-32">
        <div className="max-w-2xl">
          ...
          <p className="text-lg text-primary-foreground/80 leading-relaxed animate-fade-in" style={{ animationDelay: "0.2s" }}>
            NorthBridge Service Assist is an independent third-party service assistance platform launched in 2026, helping Canadians navigate internet, broadband, Wi-Fi, and cable TV services.
          </p>
        </div>
      </div>
    </section>
