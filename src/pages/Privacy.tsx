...
const sections = [
  { icon: Server, title: "Secure Website", text: "Go Canada Wifi operates a secure HTTPS website. All communications between your browser and our platform are encrypted using industry-standard SSL/TLS protocols." },
  { icon: Eye, title: "Information Usage", text: "Any information you provide to Go Canada Wifi is used solely for the purpose of delivering our independent assistance services. We do not use your information for any purpose beyond providing the guidance and support you have requested." },
  ...
  { icon: Lock, title: "No Collection of Provider Passwords", text: "Go Canada Wifi does not request, collect, or store any passwords or sensitive login credentials related to your internet, broadband, or cable TV service providers." },
