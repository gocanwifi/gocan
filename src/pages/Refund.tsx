...
const sections = [
  ...
  { icon: Mail, title: "How to Request a Refund", text: "To submit a refund request, please contact us at support@gocanadawifi.com or call (888) 651-7421.", hasLinks: true },
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    {s.hasLinks ? (
                      <>
                        ...
                        or call <a href="tel:+18886517421" className="text-primary hover:underline">(888) 651-7421</a>.
                      </>
                    ) : s.text}
                  </p>
                </div>
